...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "展示 1 到 10 行 共 57 行") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default 展示 _START_ 到 _END_ 行 共 _TOTAL_ 行
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "展示 _START_ 到 _END_ of _TOTAL_ 行",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the '显示 x of y 行' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
